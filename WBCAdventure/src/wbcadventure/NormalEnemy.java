...
public class NormalEnemy extends Enemy {
    ...
    public int randomHP(WBC wbc){
        ...
        switch(casenum){
            case 0 : enemyRandHP=(int)(wbcHP*1); break;
            case 1 : enemyRandHP=(int)(wbcHP*1.1); break;
            case 2 : enemyRandHP=(int)(wbcHP*1.2); break;
            case 3 : enemyRandHP=(int)(wbcHP*1.3); break;
            case 4 : enemyRandHP=(int)(wbcHP*1.4); break;
            case 5 : enemyRandHP=(int)(wbcHP*1.5); break;
            case 6 : enemyRandHP=(int)(wbcHP*1.6); break;
            case 7 : enemyRandHP=(int)(wbcHP*1.7); break;
            ...
            case 36 : enemyRandHP=(int)(wbcHP*2.11); break;
            case 37 : enemyRandHP=(int)(wbcHP*2.12); break;
            case 38 : enemyRandHP=(int)(wbcHP*3.13); break;
            case 39 : enemyRandHP=(int)(wbcHP*2.14); break;
            case 40 : enemyRandHP=(int)(wbcHP*2.15); break;
            case 41 : enemyRandHP=(int)(wbcHP*2.16); break;
            case 42 : enemyRandHP=(int)(wbcHP*2.17); break;
            case 43 : enemyRandHP=(int)(wbcHP*2.18); break;
